...
const InventoryControl = () => {
  const [activeView, setActiveView] = useState<"stock" | "demand">("stock");
      ...
      <CardContent className="pt-6">
        <div className="mb-4 flex items-center justify-between">
          ...
          <Button className="bg-cyan-600 hover:bg-cyan-700">
            ...
            {activeView === "stock" ? "Add Inventory Item" : "Create Forecast"}
          </Button>
        </div>

        {activeView === "stock" ? (
          <StockLevels searchTerm={searchTerm} />
        ) : (
          <DemandForecasting searchTerm={searchTerm} />
        )}
      </CardContent>
    </Card>
  );
