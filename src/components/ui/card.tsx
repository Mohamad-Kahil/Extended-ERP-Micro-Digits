...
>(({ className, ...props }, ref) => (
  <div
    ref={ref}
    className={cn(
      "rounded-md border border-slate-800/80 bg-slate-900/60 text-slate-200 shadow-sm backdrop-blur-sm card-hover",
      className,
    )}
    {...props}
  />
...
>(({ className, ...props }, ref) => (
  <h3
    ref={ref}
    className={cn(
      "text-xs font-medium leading-none tracking-tight text-white",
      className,
    )}
    {...props}
  />
